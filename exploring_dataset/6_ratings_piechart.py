...
from chart_def import chart_piechart
from chart_def import chart_def_stream
from chart_def import chart_sankey
from chart_def import chart_var_pie
...
def app():
    ...
    hc = jp.HighCharts(a=wp, options=chart_piechart)
